...
var/global/sort_instance/sortInstance = new
...
/sort_instance/proc/timSort(start, end)
	runBases.Cut()
	runLens.Cut()
	...
	*/
/sort_instance/proc/binarySort(lo, hi, start)
	...
	*/
/sort_instance/proc/countRunAndMakeAscending(lo, hi)
	//ASSERT(lo < hi)
...
/sort_instance/proc/minRunLength(n)
	//ASSERT(n >= 0)
...
/sort_instance/proc/mergeCollapse()
...
/sort_instance/proc/mergeForceCollapse()
	while(runBases.len >= 2)
		var/n = runBases.len - 1
...
/sort_instance/proc/mergeAt(i)
	...
	*/
/sort_instance/proc/gallopLeft(key, base, len, hint)
	 ...
	 */
/sort_instance/proc/gallopRight(key, base, len, hint)
	//ASSERT(len > 0 && hint >= 0 && hint < len)
...
/sort_instance/proc/mergeLo(base1, len1, base2, len2)
...
/sort_instance/proc/mergeHi(base1, len1, base2, len2)
	//ASSERT(len1 > 0 && len2 > 0 && base1 + len1 == base2)
...
/sort_instance/proc/mergeSort(start, end)
	var/remaining = end - start
